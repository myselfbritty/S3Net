...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'Organized/fold1/coco-annotations/instances_train_sub.json', #######Annotation file coco format for training dataset
    ...
    val=dict(
        ...
        ann_file=data_root + 'Organized/fold1/coco-annotations/instances_val_sub.json', #######Annotation file coco format for testing dataset
